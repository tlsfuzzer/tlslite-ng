    ...
    def _sanityCheckSignatureAlgs(other):
        ...
        if len(not_allowed) > 0:
            raise ValueError("Following signature algorithms are not allowed: "
                             "{0}".format(str(not_allowed).strip('[]')))
