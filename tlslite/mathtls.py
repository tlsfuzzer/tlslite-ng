...
goodGroupParameters = [(2, int("EEAF0AB9ADB38DD69C33F80AFA8FC5E860726187"
                       ...
                       (19, int("FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B"
                                "80DC1CD129024E08"
                                "8A67CC74020BBEA63B139B22514A08798E3404DD"
                                "EF9519B3CD3A431B"
                                "302B0A6DF25F14374FE1356D6D51C245E485B576"
...
def calcKey(version, secret, cipher_suite, label, handshake_hashes=None,
    ...
    :param str label: label for the key you want to calculate
    ...
    if label == "key expansion":
        seed = server_random + client_random
    if label == "master secret":
        seed = client_random + server_random

    if func == PRF_SSL:
        return func(secret, seed, output_length)
    return func(secret, compatAscii2Bytes(label), seed, output_length)
