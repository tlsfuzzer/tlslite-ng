...
class HandshakeSettings(object):
    ...
    :ivar certificate_compression: a list of compression algorithms that will
        be used to compress the certificate if compress_cerificate(27)
    ...
    :ivar certificate_compression: a list of compression algorithms that will
        be used to compress the certificate if compress_cerificate(27)
        extension is supported in the handshake. This option is for when a
        certificate was received/decompressed by this peer.
    ...
    def _sanityCheckExtensions(other):
        ...
        if other.certificate_compression_send:
            if isinstance(other.certificate_compression_send, str):
                ...
                raise ValueError("certificate_compression must be a list of "
                                 "strings or a string")
        ...
        if other.certificate_compression_receive:
            if isinstance(other.certificate_compression_receive, str):
