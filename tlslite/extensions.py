...
class DelegatedCredentialExtension(TLSExtension):
    ...
    """
    def __init__(self):
        """Create instance of DelegatedCredentialExtension."""
...
class SignatureSchemeExtension(_SigListExt):
    ...
    def __init__(self):
        """Create instance of class"""
        super(SignatureSchemeExtension, self).__init__(
            1, 2, 2,
            'sigalgs',
...
TLSExtension._universalExtensions = {
    ...
    ExtensionType.delegated_credential: SignatureSchemeExtension
}
