...
class TLSConnection(TLSRecordLayer):
    ...
    @deprecated_params({"async_": "async"},
                       "'{old_name}' is a keyword in Python 3.7, use"
                       "'{new_name}'")
    def handshakeClientCert(self, cert_chain=None, privateKey=None,
        ...
        :param cert_chain: The certificate chain to be used if the
        ...
        """
        handshaker = \
                self._handshakeClientAsync(certParams=(cert_chain, privateKey),
    ...
    def handshakeServer(self, verifierDB=None,
                        cert_chain=None, privateKey=None, reqCert=False,
        ...
        for result in self.handshakeServerAsync(verifierDB,
                cert_chain, privateKey, reqCert, sessionCache, settings,
                checker, reqCAs,
    ...
    def handshakeServerAsync(self, verifierDB=None,
        ...
        handshaker = self._handshakeServerAsyncHelper(\
            verifierDB=verifierDB, cert_chain=cert_chain,
