...
def choose_compression_send_algo(version, advertized_algos, valid_algos):
    if not advertized_algos or not version or version < (3, 4):
        return None
        ...
        for algo in valid_algos:
            try:
                supported_comp_algos.append(
                    getattr(CompressionAlgorithm, algo))
