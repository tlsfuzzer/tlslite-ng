...
class TestAESCTR(unittest.TestCase):
    def test___init__(self):
        key = bytearray(16)
        aesCTR = Python_AES_CTR(key, mode=6)
    ...
    def test_encrypt_with_test_vector_1(self):
        ...
        aesCTR = Python_AES_CTR(key, mode=6)
        self.assertEqual(aesCTR.encrypt(plaintext, counter), ciphertext)
    ...
    def test_decrypt_with_test_vector_1(self):
        ...
        aesCTR = Python_AES_CTR(key, mode=6)
        self.assertEqual(aesCTR.decrypt(ciphertext, counter), plaintext)
