...
from tlslite.mathtls import PRF_1_2, calcKey, paramStrength
from tlslite.handshakehashes import HandshakeHashes
from tlslite.constants import CipherSuite

class TestCalcMasterSecret(unittest.TestCase):
    def test_with_empty_values(self):
        ret = calcKey((3, 3), bytearray(48), 0,
                      "master secret",
                      clientRandom=bytearray(32),
                      serverRandom=bytearray(32),
                      outputLength=48)
...
class TestCalcExtendedMasterSecret(unittest.TestCase):
    ...
    def test_with_TLS_1_0(self):
        ret = calcKey((3, 1), bytearray(48), 0,
                      "extended master secret",
                      handshakeHashes=self.handshakeHashes,
                      outputLength=48)
...
class TestCalcFinishedInSSL3(TestCalcFinished):
    def setUp(self):
        ...
        self.finished = calcKey((3, 0), bytearray(48), 0, "client finished",
                                handshakeHashes=self.hhashes,
                                outputLength=12)
    ...
    def test_server_value(self):
        ret = calcKey((3, 0), bytearray(48), 0, "server finished",
                      handshakeHashes=self.hhashes,
                      outputLength=12)
    ...
    def test_if_multiple_runs_are_the_same(self):
        ret2 = calcKey((3, 0), bytearray(48), 0, "client finished",
                       handshakeHashes=self.hhashes,
                       outputLength=12)
    ...
    def test_if_client_and_server_values_differ(self):
        ret_srv = calcKey((3, 0), bytearray(48), 0, "server finished",
                          handshakeHashes=self.hhashes,
                          outputLength=12)
...
class TestCalcFinishedInTLS1_0(TestCalcFinished):
    def setUp(self):
        ...
        self.finished = calcKey((3, 1), bytearray(48), 0, 'client finished',
                                handshakeHashes=self.hhashes,
                                outputLength=12)
    ...
    def test_server_value(self):
        ret_srv = calcKey((3, 1), bytearray(48), 0, "server finished",
                          handshakeHashes=self.hhashes,
                          outputLength=12)
    ...
    def test_if_values_for_TLS1_0_and_TLS1_0_are_same(self):
        ret = calcKey((3, 2), bytearray(48), 0, "client finished",
                      handshakeHashes=self.hhashes,
                      outputLength=12)
...
class TestCalcFinishedInTLS1_2WithSHA256(TestCalcFinished):
    def setUp(self):
        ...
        self.finished = calcKey((3, 3), bytearray(48), 0, "client finished",
                                handshakeHashes=self.hhashes,
                                outputLength=12)
    ...
    def test_server_value(self):
        ret_srv = calcKey((3, 3), bytearray(48), 0, "server finished",
                          handshakeHashes=self.hhashes,
                          outputLength=12)
...
class TestCalcFinishedInTLS1_2WithSHA384(TestCalcFinished):
    def setUp(self):
        ...
        self.finished = calcKey((3, 3), bytearray(48),
    ...
    def test_server_value(self):
        ret_srv = calcKey((3, 3), bytearray(48),
                          CipherSuite.TLS_RSA_WITH_AES_256_GCM_SHA384,
                          "server finished",
                          handshakeHashes=self.hhashes,
                          outputLength=12)
