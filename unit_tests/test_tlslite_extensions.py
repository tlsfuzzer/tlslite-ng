...
from tlslite.extensions import TLSExtension, SNIExtension, NPNExtension,\
        ...
        SessionTicketExtension, CompressCertificateExtension
...
class TestCompressCertificateExtension(unittest.TestCase):
    ...
    def test_create(self):
        ...
        self.assertIsInstance(ext, CompressCertificateExtension)
        self.assertEqual(ext.algorithms, [1, 2, 3])

    def test_write(self):
        ext = CompressCertificateExtension().create([1, 2, 3])
    ...
    def test___repr__(self):
        ...
        self.assertEqual(
            repr(ext),
            "CompressCertificateExtension(algorithms=[zlib, brotli, zstd])")
