...
class TestASN1Parser(unittest.TestCase):
    def test_integer(self):
        ...
        self.assertEqual(0, p.type.tagClass)
        self.assertEqual(0, p.type.isPrimitive)
        self.assertEqual(2, p.type.tagId)
    ...
    def test_bitstring(self):
        ...
        self.assertEqual(0, p.type.tagClass)
        self.assertEqual(0, p.type.isPrimitive)
        self.assertEqual(3, p.type.tagId)
    ...
    def test_utctime(self):
        ...
        self.assertEqual(0, p.type.tagClass)
        self.assertEqual(0, p.type.isPrimitive)
        self.assertEqual(23, p.type.tagId)
    ...
    def test_sequence(self):
        ...
        self.assertEqual(0, p.type.tagClass)
        self.assertEqual(1, p.type.isPrimitive)
        self.assertEqual(16, p.type.tagId)
    ...
    def test_explicit_string(self):
        ...
        self.assertEqual(2, p.type.tagClass)
        self.assertEqual(1, p.type.isPrimitive)
        self.assertEqual(3333, p.type.tagId)
