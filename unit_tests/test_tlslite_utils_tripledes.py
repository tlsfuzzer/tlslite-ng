...
class Test3DES_KATs_KO3(unittest.TestCase):
    ...
    def test_3des_vartext_encrypt(self):
        ...
        self.assertEqual(
            self.tripleDes.encrypt(b'\x80\x00\x00\x00\x00\x00\x00\x00'),
    ...
    def test_3des_invperm_encrypt(self):
        ...
        self.assertEqual(
            self.tripleDes.encrypt(b'\x95\xf8\xa5\xe5\xdd\x31\xd9\x00'),
                                   b'\x80\x00\x00\x00\x00\x00\x00\x00')
    ...
    def test_3des_invperm_decrypt(self):
        ...
        self.assertEqual(
            self.tripleDes.decrypt(b'\x80\x00\x00\x00\x00\x00\x00\x00'),
                                   b'\x95\xf8\xa5\xe5\xdd\x31\xd9\x00')
    ...
    def test_3des_varkey_encrypt(self):
        ...
        self.assertEqual(
            self.tripleDes.encrypt(b'\x00\x00\x00\x00\x00\x00\x00\x00'),
    ...
    def test_3des_varkey_decrypt(self):
        ...
        self.assertEqual(
            self.tripleDes.decrypt(b'\x95\xa8\xd7\x28\x13\xda\xa9\x4d'),
    ...
    def test_3des_permop_decrypt(self):
        ...
        self.assertEqual(
            self.tripleDes.decrypt(b'\x88\xd5\x5e\x54\xf5\x4c\x97\xb4'),
                                   b'\x00\x00\x00\x00\x00\x00\x00\x00')
    ...
    def test_3des_subtab_encrypt(self):
        ...
        self.assertEqual(
            self.tripleDes.encrypt(b'\x01\xa1\xd6\xd0\x39\x77\x67\x42'),
        ...
        self.assertEqual(
            self.tripleDes.encrypt(
                bytearray(b'\x80\x00\x00\x00\x00\x00\x00\x00' +
                          b'\x80\x00\x00\x00\x00\x00\x00\x00' +
                          b'\x80\x00\x00\x00\x00\x00\x00\x00')),
                bytearray(b'\x94\x93\xb0\xcd\x54\xf9\x76\xad' +
        ...
        self.assertEqual(
            self.tripleDes.encrypt(
                bytearray(b'\x80\x00\x00\x00\x00\x00\x00\x00' +
                          b'\x80\x00\x00\x00\x00\x00\x00\x00' +
                          b'\x80\x00\x00\x00\x00\x00\x00\x00')),
                bytearray(b'\x56\x28\x4a\x04\xc9\xb5\xf7\xb6' +
...
class Test3DES_components(unittest.TestCase):
    ...
    def test_iv_not_correct(self):
        key = bytearray(b'\x7c\xa1\x10\x45\x4a\x1a\x6e\x57' +
                        b'\x7c\xa1\x10\x45\x4a\x1a\x6e\x57' +
                        b'\x7c\xa1\x10\x45\x4a\x1a\x6e\x57')
        IV = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00'
